...
public class TreeSetDemo {
	...
	public static void main(String a[]) {
		...
		nameComp.add(new Empl("Joe", 3000));
 ...
 * 
 * @Override public int compare(Empl e1, Empl e2) { if (e1.getSalary() >
 * e2.getSalary()) { return 1; } else { return -1; } } }
 */
 ...
 * 
 * public Empl(String n, int s) { this.name = n; this.salary = s; }
 * 
 ...
 * 
 * public String toString() { return "Name: " + this.name + "-- Salary: " +
 * this.salary; } }
 */
